...
def make_env(env_id, idx, capture_video, run_name, gamma):
    def thunk():
        if capture_video and idx == 0:
            ...
            # Record video much less frequently to reduce storage and improve performance
                ...
                for info in infos["final_info"]:
                    if info and "episode" in info:
                        ...
                        if args.track and args.capture_video:
                            ...
                            if video_files:
                                wandb.log({"video": wandb.Video(video_files[-1], fps=4, format="mp4")}, step=global_step)
