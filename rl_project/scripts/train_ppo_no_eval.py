...
"""
PPO Training for Finger Push Task - No Evaluation Mode
Fast training with complete WandB logging
"""
...
def parse_args():
    ...
    parser.add_argument("--wandb-project-name", type=str, default="mujoco_tutorial",
        help="the wandb's project name")
    parser.add_argument("--wandb-entity", type=str, default="mdabu-hanif-university-of-trento",
        help="the entity (team) of wandb's project")
    parser.add_argument("--capture-video", type=lambda x: bool(strtobool(x)), default=False, nargs="?", const=True,
        help="whether to capture videos of the agent performances (check out `videos` folder)")

    # Algorithm specific arguments
    parser.add_argument("--env-id", type=str, default="FingerPush-v0",
...
if __name__ == "__main__":
    import sys
    sys.path.append('/Users/pranav/Downloads/finger_tips')
    sys.path.append('/Users/pranav/Downloads/finger_tips/rl_project')
    
    # Import the environment registration
    import os
    os.chdir('/Users/pranav/Downloads/finger_tips')
    from envs.register_envs import *
    ...
    device = torch.device("cpu")  # Force CPU for maximum MuJoCo performance
    ...
    print(f"   📊 WandB tracking: {args.track}")
    ...
    # Save model
    model_path = f"runs/{run_name}/finger_push_ppo.cleanrl_model"
